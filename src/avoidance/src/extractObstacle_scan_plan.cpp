...
double avoidcoff;
//void pathPointHandler(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
...
//    ros::Subscriber subPathPoint = nh.subscribe<sensor_msgs::PointCloud2>
//				("/velodyne_points", 2, &pathPointHandler);
